...
class CinemagicScraper(BaseScraper):
    ...
    def fetch_showtimes(self, start_date: datetime, num_days: int = 7) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Parse movie listings (template - adjust for actual structure)
            ...
            for container in movie_containers:
                try:
                    ...
                    print(f"Error parsing movie in Cinemagic: {e}")
                    continue

        except Exception as e:
            print(f"Error fetching Cinemagic showtimes: {e}")
