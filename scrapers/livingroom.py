...
class LivingRoomScraper(BaseScraper):
    """Scraper for Living Room Theaters (using Playwright for JS rendering)."""
            ...
            with sync_playwright() as p:
                ...
                for element in movie_elements:
                    try:
                        ...
                        print(f"Error parsing movie in Living Room: {e}")
                        continue

                browser.close()

        except Exception as e:
            print(f"Error fetching Living Room showtimes: {e}")
